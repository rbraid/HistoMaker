...
//   TH3I *temp3INT = 0;
  ...
  {
    outlist->Add(new TH2D(Form("GamPerRing_10Be_d%i_pid_opp",id),"Doppler Corrected Energy Vs Ring with PID Detection, based on doppler correction of opposite 10Be",10000,0,10,50,0,50));
    temp2 = (TH2D*)outlist->FindObject(Form("GamPerRing_10Be_d%i_pid_opp",id));
